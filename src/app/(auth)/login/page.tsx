        ...
        >
          <div className="flex flex-col gap-1">
            ...
            <p className="text-xs leading-relaxed" style={{ color: "var(--color-text-muted)" }}>
              Puedes escuchar y ver sin cuenta. Para interactuar necesitas registrarte.
            </p>
          </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 rounded-xl px-4 py-3.5 font-semibold text-sm transition-all duration-200"
            style={{ background: "var(--color-primary)", color: "#000" }}
            onMouseEnter={(e) => {
              (e.currentTarget as HTMLElement).style.boxShadow =
                "0 0 24px rgba(212,160,23,0.45)";
            }}
            onMouseLeave={(e) => {
          ...
          <p className="text-xs text-center" style={{ color: "var(--color-text-muted)" }}>
            Al continuar aceptas los términos de uso de la plataforma Elim LLDM.
          </p>
        </div>
